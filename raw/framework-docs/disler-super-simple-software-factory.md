...
Source note: Apple Notes 2026-08-15: simple software factory reference; mine UX mode toggle, factory primitives, and realistic E2E qualification scenario ideas.
Extraction method: github-api-readme-docs
Extraction attempts: repo-api:200; readme-api:200; llms.txt:miss; docs/llms.txt:miss; docs/LLMS.txt:miss; docs/README.md:miss; docs/readme.md:miss; docs/index.md:miss; docs/overview.md:miss

# GitHub Repository: disler/super-simple-software-factory

Source: https://github.com/disler/super-simple-software-factory
Description: Repeatable agents-plus-code workflows, packaged as one skill, stamped into any repo. Deterministic Python owns the graph; coding agents are bounded nodes inside it.
Default branch: main
Stars: 697
Forks: 165
License: MIT
