...
# Source Capture: Anatomy of a Frontier Lab Agent Intrusion: A Technical Timeline of the July 2026 Incident

- Source URL: https://huggingface.co/blog/agent-intrusion-technical-timeline
- Source note: Apple Notes 2026-08-04 via @bibryam: autonomous-agent intrusion timeline; mine sandbox escape, dataset/config injection, credential exposure, Kubernetes pivot, and agent-security mitigations.
- Extraction method: raw GitHub markdown source linked by Hugging Face blog page

---
## Hugging Face blog markdown source

Source: https://raw.githubusercontent.com/huggingface/blog/main/agent-intrusion-technical-timeline.md
